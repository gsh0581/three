...
import { tileGeometry, generateNumGeometry } from '../geomertries'
import { tileMaterial, numMaterial } from '../material'
...
@Component<Tile>({
  mounted() {
    this.$nextTick(() => {
      ...
      this.object3D.add(new THREE.Mesh(generateNumGeometry(this.value), numMaterial))
